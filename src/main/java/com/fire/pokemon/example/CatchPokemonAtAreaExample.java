...
package com.fire.pokemon.example;
...
public class CatchPokemonAtAreaExample {
	...
	public static void main(String[] args) {
		...
		try {
			...
			PokemonGo go = new PokemonGo(new PtcCredentialProvider(http, "327872612", "bmzy10710ZHG"), http);
			// set location
			go.setLocation(-34.915680, 138.594449, 0);
